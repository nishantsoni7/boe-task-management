...
function PaymentPositionPanel({
  ...
  // THE ATTACHED FIGURES, when the server reports them (20261113000000): the
...
export function PiSubmitConfirmModal({
   ...
   * comparison made here. Since 20261113000000 that is `attached_meets_standard`
 ...
 */
/**
 * The three doors one dialog serves (20261113000000). The words change; the
