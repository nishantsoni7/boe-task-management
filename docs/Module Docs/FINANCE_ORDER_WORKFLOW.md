...
## 13. The PI decision, the Confirmed-Order gate, PI versions and production alignment (`20261113000000`)

> **NOT APPLIED.** `20261113000000_order_submission_pi_review_gate_versions_and_production.sql`
> exists in the repository and has **not** been run against the linked database.
