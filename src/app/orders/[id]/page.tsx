...
type Order = {
  ...
  // Production alignment (20261113000000). 'not_aligned' on every Order at
...
export default function OrderDetailPage() {
  ...
  // ── The PI's versions and its trail (20261113000000) ──
  //
  ...
  // ── Production alignment (20261113000000) ──
  ...
  /**
   * THE PI HISTORY AND WHO MAY MOVE IT (20261113000000).
   *
  ...
  return (
    ...
    >
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
            ...
            {/* Production alignment: the Head of Manufacturing's door
                (20261113000000). Drawn only for orders.align_production, never
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        {/* THE PI HISTORY (20261113000000): the current PI, a pending revision
      ...
      {/* ── PI revision and production alignment dialogs (20261113000000) ── */}
