...
describe('REGRESSION — the existing Finance and Orders surfaces are unchanged', () => {
  ...
  test('anything it adds under supabase/tests belongs to the expense suite', () => {
    ...
    for (const f of added) {
      assert.ok(/expense_lifecycle|personal_module_order|order_operations_handoff|order_0524_operations_handoff|order_document_submissions|announcements/.test(f),
