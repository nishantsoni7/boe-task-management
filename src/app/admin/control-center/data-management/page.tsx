...
export default function DataManagementPage() {
  ...
  return (
    <ControlCenterLayout
      ...
      subtitle="Clear Order and Finance test data while the system is in testing."
      onSignOut={signOut}
    >
            ...
            {scope && preview && (
              <div style={{ ...CARD, marginTop: 16 }}>
                ...
                {blocked ? (
                  ...
                  <div style={MUTED}>
                    There is no test data in this scope. Nothing would be deleted.
                  </div>
                ) : (
                  <>
                    ...
                    <div style={{ marginBottom: 12 }}>
                      ...
                      <input
                        ...
                        placeholder="e.g. resetting after the Order approval test run"
                      />
                    </div>
...
function ProjectBanner({ projectRef }: { projectRef: string | null }) {
  ...
  return (
    <div style={{
      ...
      <strong style={{ color: '#1A2035' }}>{projectRef}</strong>. Only records created while
      Test Data Cleanup was enabled are ever in scope.
    </div>
  )
}
